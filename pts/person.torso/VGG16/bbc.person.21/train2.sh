...
# 	cd $RootDir
# 	./pts/person.torso/VGG16/bbc.person.21/train2.sh 0 VGG16 --set RNG_SEED 1701
# 	./pts/person.torso/VGG16/bbc.person.21/train2.sh 1 VGG16 --set RNG_SEED 1701
...
exper_dir="person.torso/${NET}/bbc.person.21/"
