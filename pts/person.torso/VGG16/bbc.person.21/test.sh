...
log_file=logs/person.torso_VGG16_bbc.person.21_demo_bbc_pose.log
rm $log_file
...
cfg_file="${root}/pts/person.torso/VGG16/bbc.person.21/test.yml"

caffemodel="${root}/output/person.torso/VGG16/bbc.person.21/VGG16_faster_rcnn_final.caffemodel"
