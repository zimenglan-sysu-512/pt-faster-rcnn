#!/bin/bash
# Usage:
# 	./pts/torso/VGG16/bbc.torso.21.2/train_torso.sh GPU NET [--set ...]
# Example:
# 	RootDir=/home/ddk/dongdk/pt-fast_rcnn/
# 	cd $RootDir
# 	./pts/person.torso/VGG16/bbc.torso.21.2/train2.sh 0 VGG16 --set RNG_SEED 1701
# 	./pts/person.torso/VGG16/bbc.torso.21.2/train2.sh 1 VGG16 --set RNG_SEED 1701
...
exper_dir="person.torso/${NET}/bbc.torso.21.2/"
