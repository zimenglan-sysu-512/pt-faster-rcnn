...
log_file=logs/person.torso_VGG16_bbc.torso.21.2_demo_bbc_pose.log
rm $log_file
...
im_path="/home/ddk/dongdk/dataset/bbc_pose/crop.data/"
...
def="${root}/pts/person.torso/VGG16/bbc.torso.21.2/faster_rcnn_test.pt"

cls_filepath="${root}/pts/person.torso/pascal_voc_classes_names.filepath"

cfg_file="${root}/pts/person.torso/VGG16/bbc.torso.21.2/test.yml"

caffemodel="${root}/output/person.torso/VGG16/bbc.torso.21.2/VGG16_faster_rcnn_final.caffemodel"
