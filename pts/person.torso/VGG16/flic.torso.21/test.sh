...
im_path="~/dongdk/dataset/FLIC/crop.images2/"

# out_file="person.bbox.txt"	# write the detected results (bboxes) into file if given

out_dire="~/dongdk/dataset/FLIC/vision/torso/"
mkdir -p $out_dire
...
caffemodel="~/dongdk/pt-fast-rcnn/output/person.torso/VGG16/flic.torso.21/VGG16_faster_rcnn_final.caffemodel"
