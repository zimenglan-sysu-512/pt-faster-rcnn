#!/bin/bash
# Usage:
# 	./pts/torso/VGG16/torso.only.21/train_torso.sh GPU NET [--set ...]
# Example:
# 	RootDir=/home/dongdk/faster_rcnn/
# 	cd $RootDir
# 	./pts/person.torso/VGG16/torso.only.21/train_torso.sh 0 VGG16 --set RNG_SEED 1701
...
exper_dir="person.torso/${NET}/torso.only.21/"
